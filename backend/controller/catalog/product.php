...
use Backend\Http\Controllers\Catalog\ProductController;
...
class ControllerCatalogProduct extends Controller
{
    ...
    public function delete()
    {
        ...
        if (request()->has('selected') && $this->validateDelete()) {
            foreach (request()->selected as $product_id) {
    ...
    protected function getForm()
    {
        ...
        $productComplectionController = new ProductController();
        $data['complectationTab'] = $productComplectionController->complectationTab($productModel)->render();
